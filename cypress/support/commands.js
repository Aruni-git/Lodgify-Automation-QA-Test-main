...
function selectMonth(currentMonth,arrivalMonth,arrivalDate,departureDate,departureMonth){

    cy.get('div').contains(currentMonth).then( dateAttribute => 
      {
        debugger
...
Cypress.Commands.add("selectDepartureMonth", 
function selectDepartureMonth(currentMonth,departureDate,departureMonth){
    ...
    cy.get('div').contains(currentMonth).then( dateAttribute => 
      ...
      .then((text1) => {
        currentMonth =text1
        cy.get('.DayPickerNavigation_leftButton__horizontalDefault > .DayPickerNavigation_svg__horizontal').click()
        return selectDepartureMonth(currentMonth,departureDate,departureMonth)
