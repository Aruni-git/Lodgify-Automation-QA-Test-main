...
const twoYearPlan = "https://www.lodgify.com/pricing/#";
...
context("Lodgify pricing page", () => {
  ...
  it("should be able navigate to the new page", () => {
    onPricingPage.navigateToTwoYearPlan(twoYearPlan);
  });
  ...
  it("verify proffessional package for two year plan", () => {
    onPricingPage.verifyProfessionalPackageForTwoYear(
  ...
  it("verify ultimate package for two year plan", () => {
    onPricingPage.verifyUltimatePackageForTwoYears(
      ultimate_Package,
      txtUltimate
    );
  });
